    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="mailto:gandharvkumar107@gmail.com"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/gurugandharv/"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
                LinkedIn
              </a>
            ...
            <li>
              <a
                href="https://github.com/gurugandharv11"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
                GitHub
              </a>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Guru Gandharv</li>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          {"© 2026 Gandharv\"</>\"\""}. All rights reserved.
        </p>
